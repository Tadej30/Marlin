...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN 10    // Fan2_PIN = PE6 SKR PRO 1.1 CONTROLLER FAN
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 20*60, 20*60, 5*60, 2*50 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
