...
// Fans
//
#define FAN0_PIN                            PE5  // Fan0 = LAYER FAN
#define FAN1_PIN                            PC8  // Fan1 = EXTRUDER FAN
#define FAN3_PIN                            PB0  // Fan3 = CHAMBER FAN

#ifndef E0_AUTO_FAN0_PIN
  #define E0_AUTO_FAN0_PIN               FAN1_PIN
#endif

#if !defined(CONTROLLER_FAN0_PIN) && ENABLED(USE_CONTROLLER_FAN) && HOTENDS < 2
  #define CONTROLLER_FAN0_PIN          FAN2_PIN   // Fan2 = SKR PRO 1.1 CONTROLLER FAN
#else
