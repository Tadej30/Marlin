...
#define STRING_CONFIG_H_AUTHOR "(T.Sprem 30.1.2023)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200, 200, 1600, 350.40}
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.054 // (0.013mm) Distance from real junction edge
