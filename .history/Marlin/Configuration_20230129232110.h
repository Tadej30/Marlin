...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
#define DEFAULT_Kp 19.6280
#define DEFAULT_Ki 1.5627
#define DEFAULT_Kd 61.6319
  #endif
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 400, 350.40}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 0,-1.030}  // old -1.240
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_RETRACT_MULTIPLIER   0.3  // G26 Q (retraction) used by default between mesh test elements.
  #endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (5), (210), 30 }
