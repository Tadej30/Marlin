...
//
  ...
  #define FAN3_PIN                   PB0   // Remove the fan signal on pin P2_04 (example: SKR 1.4 Turbo HE1 plug)
...
//
  ...
  #define BOARD_MAXTEMP          75  // (°C)
    ...
    #define TEMP_BOARD_PIN      TEMP_2_PIN // T3 <-> (E2) SKR PRO 1.1 temp. sensor
  #endif
#endif
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN0_PIN PE6           // Set a custom pin for the controller fan
  ...
  #define CONTROLLER_FAN_MIN_BOARD_TEMP 45  // (°C) Turn on the fan if the board reaches this temperature
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // Fan1 = EXTRUDER FAN
...
#define EXTRUDER_AUTO_FAN_SPEED 135   // 127=50% -12V FAN! 255 == full speed 24V FAN
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 130   // Set default power-up brightness (0-255, requires PWM pin)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_MIN_Z_CHANGE 0.04 // (mm) Minimum Z change before saving power-loss data
  ...
  #define SD_ABORT_ON_ENDSTOP_HIT
    ...
    #define SD_ABORT_ON_ENDSTOP_HIT_GCODE "G28 X5 Y210" // G-code to run on endstop hit (e.g., "G28XY" or "G27")
  #endif
