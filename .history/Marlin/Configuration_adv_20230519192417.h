...
//
  ...
  //#define HEATER_CHAMBER_INVERTING fals

  //#define CHAMBER_FAN               // Enable a fan on the chamber
  #if ENABLED(CHAMBER_FAN)
    #define CHAMBER_FAN_INDEX   PB0   // Index of a fan to repurpose as the chamber fan. (Default: first unused fan)
 ...
 */
  ...
  #define ADAPTIVE_FAN_SLOWING              // Slow part cooling fan if temperature drops
    ...
    #define NTEMP_TUNING_MAINTAIN_FAN    // Don't slow fan speed during M303
  #endif
