...
/**
 * Heated Chamber settings // Electronic temp. sensor
 */
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 16*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "G28 Z+10 X5 Y215"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
