...
#define STRING_CONFIG_H_AUTHOR "(T.Sprem 19.8.2020)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prusa MK3/s"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "165f2846-12b6-4c04-8592-80f86a3e7b5d"
...
#define PS_ON_PIN PF15
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_E_TEMP        55 // (°C) Turn on PSU over this temperature
    #define AUTO_POWER_CHAMBER_TEMP  55 // (°C) Turn on PSU over this temperature
    #define POWER_TIMEOUT 600           // Power off time in sec.
  #endif
#endif
...
#define TEMP_SENSOR_CHAMBER 1 //Electronic temp. sensor
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  *(measured after M106 S255 with M303 E0 S210 C10)
  */
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // 24V MK52 Heated Bed prusa MK3/s Clone
  // FIND YOUR OWN: "M303 E-1 C10 S90" to run autotune on the bed at 90 degreesC for 10 cycles.  

#define DEFAULT_bedKp 39.63
#define DEFAULT_bedKi 1.56
#define DEFAULT_bedKd 669.94
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {  100, 100, 400, 349 }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 500, 500, 100, 500 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 500, 10000 } // ...or, set your own edit limits
#endif
 ...
 *
 */
#define Z_MIN_PROBE_PIN PA2 // Pin PA2 is the SKR_Pro default pin
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 26, 4, -1.290 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN PE15        // FIL_RUNOUT_PIN PG5
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 26, 15, 15, 15 } // (mm) Left, Front, Right, Back insets
...
#define STAT_LED_RED_PIN   PF9 // Red LED
#define STAT_LED_BLUE_PIN  PF10 // Blue LED
...
#define RGBW_LED
  ...
  #define RGB_LED_R_PIN PC6
  #define RGB_LED_G_PIN PC7
  #define RGB_LED_B_PIN PC9
  #define RGB_LED_W_PIN PF8
  #endif
