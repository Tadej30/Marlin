...
#define STRING_CONFIG_H_AUTHOR "(T.Sprem 29.12.2020)" // Who made the changes.
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0700 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 0, -1.685 }
